  ...
  return (
    <div className="text-center mx-6" >
      ...
      <ul className="flex flex-wrap justify-center mb-6 ">
        {trending.map(item => <li key={item}><p onClick={() => {handlerOnClick(item)}} className="font-montserrat font-medium text-xs text-purple tracking-tighter leading-4 mx-2 dark:text-white"  href="/">{capitalizeFirstLetter(item)},</p></li>)}
      </ul>
