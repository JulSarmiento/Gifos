...
export default function GifoCard() {
  ...
  if (isloading) {
   ...
   return (
    // La altura de la card debe ser pasada por props en cada ubicacion. PENDIENTE CAMBIAR
    <div class="group relative sm:h=[187px] sm:w-[243px] lg:h-[275px] lg:w-[357px] xl:h-[275px] xl:w-[357px]">

      <div className="sm:h=[187px] sm:w-[243px] lg:h-[275px] lg:w-[357px] xl:h-[275px] xl:w-[357px]">
        <img onClick={() => setShowModal(true)} className="sm:h-[187px] sm:w-[243px] lg:h-[275px] lg:w-[357px] " src={gifo.images?.downsized?.url} alt={gifo.title} />
      </div>      

      <div class="absolute  top-0 left-0 w-full h-0 flex flex-row justify-between  items-start bg-clear-purple opacity-0 lg:group-hover:h-full lg:group-hover:opacity-100 duration-500">
